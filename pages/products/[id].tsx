    ...
    <Layout canGoback>
      <div className="px-4 py-10">
        <div className="mb-8">
          ...
          <div className="flex cursor-pointer py-3 botder-t border-b items-center space-x-3">
          ...
          <div className="mt-8">
            ...
            <div className="flex ites-center justify-between space-x-2">
              <button className="flex-1 bg-orange-500 text-white py-3 rounded-md focus:ring-offset-2 font-medium focus:ring-ornage-500 hover:bg-orange-600">
                Talk to seller
              </button>
